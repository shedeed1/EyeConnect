package thesis.auc.eyeconnect.mjpeg;
...
public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
            ...
            while (mRun) {
                ...
                if (surfaceDone) {
                    try {
                        ...
                        sourceRect = new Rect(0, 0, bmp.getWidth(), bmp.getHeight());
                        destRect = new Rect(0, 0, dispWidth, dispHeight);

                        c = mSurfaceHolder.lockCanvas();
                        synchronized (mSurfaceHolder) {

                            c.drawBitmap(bmp, sourceRect, destRect, p);
    ...
    public void startPlayback() {
        ...
        Log.d(TAG, "starrPlayback mIn == null:" + (mIn == null));
        if (mIn != null) {
            mRun = true;
            if (thread == null) {
